...
# import state_vector_machine.state_event_generator.state_event_generator as state_event_generator 
# import state_vector_machine.state_event_model.state_event_model as state_event_model




from LHCB_Velo_Toy_Models import state_event_generator
...
# Detector = state_event_generator.PlaneGeometry(module_id=[1,2,3],lx = [10,10,10],ly = [10,10,10],z = [10,20,30])
...
# state_event_gen = state_event_generator.StateEventGenerator(Detector, events = 5, n_particles=[5,5,2,2,6])
